...
import {
  PrioritizeNotificationsInput,
  PrioritizeNotificationsOutput,
} from "../../../ai/flows/prioritize-notifications";
import {
  Card,
  CardContent,
  CardDescription,
...
type PrioritizedNotification =
  PrioritizeNotificationsOutput["prioritizedNotifications"][0];
...
export default function NotificationsPanel() {
  ...
  useEffect(() => {
    const runAI = async () => {
      ...
      setError(null);
      try {
        const input: PrioritizeNotificationsInput = {
          notifications: sampleNotifications,
        };
        // const result = await prioritizeNotifications(input);
        // if (result && result.prioritizedNotifications) {
        //   const sorted = [...result.prioritizedNotifications].sort(
        //     (a, b) => b.priorityScore - a.priorityScore
        //   );
        //   setPrioritized(sorted);
        // } else {
              ...
              <CardHeader className="flex flex-row items-start gap-4 p-4">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    ...
                    <Badge>Score: {notification.priorityScore}/10</Badge>
                  </div>
                  <CardDescription>
