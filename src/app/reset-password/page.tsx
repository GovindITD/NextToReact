        ...
        <Card className="shadow-2xl border-none">
          <CardHeader className="text-center">
            <div className="mx-auto bg-primary/10 p-3 rounded-full mb-4 border border-primary/20 w-fit">
              <Image src="https://placehold.co/100x100.png" alt="Hospital Logo" width={80} height={80} data-ai-hint="hospital logo" />
            </div>
            ...
            <form onSubmit={handleReset} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                 ...
                 <p className="text-xs text-muted-foreground">Password must be minimum 8 character must includes 1 Uppercase, 1 Lowercase and 1 special character</p>
              </div>
              <div className="space-y-2">
