    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div className="text-center">
                ...
                <h1 className="text-3xl font-bold font-headline text-primary mt-2">My Token Information</h1>
                <p className="text-muted-foreground">View your current token status and generate a new one if needed.</p>
            </div>
            ...
            <Card className="shadow-lg text-center">
                ...
                <CardContent>
                    <p className="text-7xl font-extrabold text-primary tracking-wider">{token}</p>
                    <p className="text-muted-foreground mt-2">Please show this token at the registration counter.</p>
                </CardContent>
            </Card>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        If you need a new token, you can generate one here. Please note that generating a new token will invalidate your current one.
                    </CardDescription>
                </CardHeader>
