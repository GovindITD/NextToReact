...
export default function RadiologyReportsPage() {
  const [radiologyReports, setRadiologyReports] = useState(initialRadiologyReports);
      ...
      <div className="text-center">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>View your past reports. Use the date picker to filter results.</CardDescription>
                <div className="flex flex-col sm:flex-row justify-end gap-2 pt-4">
                    <Popover>
                        <PopoverTrigger asChild>
                            ...
                            >
                                ...
                                {fromDate ? format(fromDate, "LLL dd, y") : <span>Pick from date</span>}
                            </Button>
                        </PopoverTrigger>
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            ...
                            >
                                <CalendarIcon className="mr-2 h-4 w-4" />
                                {toDate ? format(toDate, "LLL dd, y") : <span>Pick to date</span>}
                            </Button>
                        </PopoverTrigger>
                        <PopoverContent className="w-auto p-0" align="end">
                            <Calendar
               ...
               <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="hidden sm:table-cell">Radiologist</TableHead>
                ...
                <TableBody>
                  {filteredReports.map((report, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell className="hidden sm:table-cell">{report.radiologist}</TableCell>
                      <TableCell>
