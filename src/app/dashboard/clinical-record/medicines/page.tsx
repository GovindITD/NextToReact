...
const medicines = [
    { name: 'Lisinopril 10mg', dosage: '1 tablet daily', prescribedBy: 'Dr. John Smith', date: '2024-07-15' },
    { name: 'Amlodipine 5mg', dosage: '1 tablet daily', prescribedBy: 'Dr. John Smith', date: '2024-07-15' },
    { name: 'Ibuprofen 400mg', dosage: 'As needed for pain', prescribedBy: 'Dr. Michael Brown', date: '2024-06-22' },
];
