        ...
        <div className="max-w-md mx-auto">
            <Card className="text-center shadow-lg">
                <CardHeader>
                    ...
                    <CardDescription>Your investigation appointment is confirmed.</CardDescription>
                </CardHeader>
                <CardContent>
                    <p>You will receive an SMS confirmation shortly. Thank you for choosing MediCare Hospitals.</p>
                </CardContent>
                <CardFooter className="flex-col gap-4">
                    <Button onClick={() => router.push('/dashboard/investigations')} className="w-full">
                        View Appointments
                    </Button>
  ...
  return (
    <div className="max-w-md mx-auto">
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-2xl font-headline text-primary">M-Pesa Payment for Investigation</CardTitle>
